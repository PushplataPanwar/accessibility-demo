  ...
  function generateSidebarHTML(sidebarLinks, currentPath) {
    return `
        <nav class="navbar bg-light navbar-light">
            <a href="index.html" class="navbar-brand mx-4 mb-3" tabindex="0">
        ...
        if (link.dropdown) {
          ...
          const dropdownItemsHTML = link.dropdown
            .map((subLink) => {
              ...
              return `<a href="${subLink.href}" class="dropdown-item ${
                isActive ? "active" : ""
                ...
                <div class="nav-item dropdown ${
                  isActiveDropdown ? "active" : ""
                    ...
                    <a href="#" class="nav-link dropdown-toggle ${
                      isActiveDropdown ? "active" : ""
                    }" data-bs-toggle="dropdown" tabindex="0"><i class="${
            link.iconClass
          } me-2"></i>${link.text}</a>
                    <div class="dropdown-menu bg-transparent border-0 ${
                      isActiveDropdown ? "show" : ""
                    }">
                        ${dropdownItemsHTML}
                    </div>
                </div>
          ...
          return `<a href="${
            link.href
          }" tabindex="0" class="nav-item nav-link ${
            isActive ? "active" : ""
